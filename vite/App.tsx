...
import { PLATFORM_DATA, UI_TEXT } from './constants';
import { PlatformID, Language } from './types';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-claude-bg text-claude-text selection:bg-claude-accent/30 selection:text-white overflow-x-hidden font-sans">
